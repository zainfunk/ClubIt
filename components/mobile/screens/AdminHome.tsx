...
export default function AdminHome() {
  ...
  const quickActions = [
    { bg: '#eef0ff', stroke: '#6366f1', icon: <path d="M12 5v14M5 12h14" />, label: 'New club', onClick: () => toast('Open Clubs to create one') },
    { bg: '#f3edff', stroke: '#8b5cf6', icon: <path d="M9 12l2 2 4-4M5 7l7-4 7 4v6c0 5-3.5 7.5-7 8.5C8.5 20.5 5 18 5 13z" />, label: 'Start election', onClick: () => router.push('/elections') },
