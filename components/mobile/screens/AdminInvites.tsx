      ...
      {!loaded ? <Loader /> : (
        <div className="m-noscroll" style={{ ...css('flex:1;overflow-y:auto;padding:6px 20px 0;'), paddingBottom: `calc(${BOTTOM(0)} + 96px)` }}>
          ...
          <div style={css('background:#eef0ff;border:1px solid #e0e3ff;border-radius:16px;padding:14px 16px;display:flex;gap:11px;margin-top:4px;')}>
            ...
            <div style={css('font-size:12.5px;color:#4c4f8a;font-weight:500;line-height:1.5;')}>Each code grants its role the moment someone enters it — student, advisor, or admin — and the codes never expire. Only share the admin &amp; advisor codes with people you trust.</div>
          </div>
        </div>
      )}
    </div>
